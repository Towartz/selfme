...
success('2', color('[ ! ]Connected','red')),
    console.log(color('⎇','red'), color('Sc ini gua susun sendiri\nNote: jangan lupa Makan yak', 'yellow'))
    console.log(color('⎇','red'), color('Source code version:', 'aqua'), color(version))
    console.log(color('⎇','red'), color('Bug? Error? Suggestion? Visit here:', 'aqua'), color('https://wa.me/6283162498175'))
    console.log(color('[SELF-BOT]'), color('PX-SENA is now online!', 'aqua'))
...
//		if (!mek.key.fromMe) return
       ...
       mek.message = (Object.keys(mek.message)[0] === 'ephemeralMessage') ? mek.message.ephemeralMessage.message : mek.message
		...
		const ownerNumber = ["6283162498175@s.whatsapp.net"] // ganti nomer lu yo
        const ownerContact = ["6283162498175"]
